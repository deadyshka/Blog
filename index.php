...
<head>
    ...
    <div>
        ...
        foreach ($row as $item => $value):
            ?>
            <h1><?= htmlspecialchars($value['title']); ?></h1>
            <br>
            <div><?= htmlspecialchars($value['body']); ?></div>
            <br>
            <div style="position: relative"><p style="font-size: 12; text-align: right"><?= $value['created']; ?></p></div>
            <hr>
        <?php endforeach ?>
    </div>
